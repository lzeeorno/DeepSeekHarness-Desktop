...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.hero.workbench',
    kind: 'single',
    scope: 'root',
    summary: 'Build/Research lens selector on the new-session screen.',
    doc: 'Build/Research lens selector on the new-session screen. Root scope: it\nis a local UI preference rather than a property of a session or prompt.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workbench WorkbenchModeHero',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-workbench WorkbenchModeBadge id \'workbench\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-conversation ContextLedgerView id \'context\'',
      'client-ui-conversation ChatView id \'chat\'',
      'client-ui-trajectory TrajectoryView id \'trajectory\'',
      'client-ui-workbench ResearchEvidenceView id \'research\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.view\', () => ctx.slots.register(\n      { name: \'conversation.view\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:75',
  },
  {
    key: 'details',
    kind: 'single',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-workbench WorkbenchModeRow id \'workbench\'',
    ],
    replaceRisk: 'none',
