...
export const zh = {
  ...
  'context.ledger.title': '上下文账本',
  'context.ledger.description': '检查当前已加载会话窗口中的持久化上下文注入；它不重建任意 provider 的完整请求。',
  'context.ledger.readOnly': '只读事件账本',
  'context.ledger.retained': '最近一次已加载压缩之后',
  'context.ledger.retained.empty': '该事件窗口中没有后续上下文注入。',
  'context.ledger.earlier': '最近一次已加载压缩之前',
  'context.ledger.earlier.empty': '该事件窗口中没有更早上下文注入。',
  'context.ledger.event': '事件 {seq}',
...
export const en = {
  ...
  'context.ledger.title': 'Context ledger',
  'context.ledger.description': 'Inspect durable context injections in the loaded session window; this does not reconstruct a provider request.',
  'context.ledger.readOnly': 'Read-only event ledger',
  'context.ledger.retained': 'After the latest loaded compaction',
  'context.ledger.retained.empty': 'No later context injection in this event window.',
  'context.ledger.earlier': 'Before the latest loaded compaction',
  'context.ledger.earlier.empty': 'No earlier context injection in this event window.',
  'context.ledger.event': 'Event {seq}',
